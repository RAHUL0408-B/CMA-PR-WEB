    ...
    <div className="auth-page">
      <div className="auth-card">
        <div className="auth-logo">
          ...
          <div style={{ fontSize: 11, color: 'var(--text-muted)', marginTop: 4 }}>Enterprise Financial Underwriting Platform</div>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          <div className="form-group">
            ...
            <input type="email" className="form-input" placeholder="ca@firm.com" value={email}
        ...
        <button onClick={handleGoogle} className="btn btn-secondary btn-lg w-full" disabled={googleLoading}>
